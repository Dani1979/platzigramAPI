...
(0, _ava2.default)('GET /:id', (() => {
  var _ref = _asyncToGenerator(function* (t) {
    ...
    let body = yield (0, _requestPromise2.default)({ url: `${url}/${id}`, json: true });
    t.deepEqual(body, { id });
  });
...
//# sourceMappingURL=../node_modules/.cache/ava/3774a3ccc5e291767ed2b5a9a424e96d.js.map